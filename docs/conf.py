#
# diskord documentation build configuration file, created by
...
extlinks = {
    'issue': ('https://github.com/nerdguyahmad/diskord/issues/%s', 'GH-'),
}
...
# pixels large.
html_favicon = './images/diskord_logo.ico'
...
latex_documents = [
  ('index', 'diskord.tex', 'diskord Documentation',
   'Rapptz', 'manual'),
]
...
man_pages = [
    ('index', 'diskord', 'diskord Documentation',
     ['Rapptz'], 1)
]
...
texinfo_documents = [
  ('index', 'diskord', 'diskord Documentation',
   'Rapptz', 'diskord', 'One line description of project.',
   'Miscellaneous'),
]
