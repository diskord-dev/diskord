...
``diskord.ext.tasks`` -- asyncio.Task helpers
====================================================
...
The goal of this diskord.py extension is to abstract all these worries away from you.

Recipes
---------

A simple background task in a :class:`~diskord.ext.commands.Cog`:

.. code-block:: python3

    from diskord.ext import tasks, commands
...
.. attributetable:: diskord.ext.tasks.Loop

.. autoclass:: diskord.ext.tasks.Loop()
    :members:
...
.. autofunction:: diskord.ext.tasks.loop
