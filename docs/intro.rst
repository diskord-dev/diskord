...
This is the documentation for diskord, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
---------------

diskord works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``diskord[voice]`` instead of ``diskord``, e.g. ::
...
diskord revolves around the concept of :ref:`events <discord-api-events>`.
